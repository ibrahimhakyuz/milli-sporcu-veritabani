...
Bu doküman, `create.sql` dosyasındaki güncel SQL Server şemasına göre hazırlanmıştır. `docs/assets/er-diagram-draft.png` dosyası mevcut çizim taslağını saklar; aşağıdaki Mermaid diyagramı ise güncel tablo ve foreign key ilişkilerini temsil eder.
